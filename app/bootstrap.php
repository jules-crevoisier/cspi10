...
Env::load(ROOT_PATH);
Request::forceHttpsRedirectIfNeeded();
...
define('APP_URL', rtrim(Request::normalizeAppUrl(Env::get('APP_URL', 'http://localhost:8000') ?? 'http://localhost:8000'), '/'));
...
define('SITE_URL', Request::normalizeAppUrl(Env::get('SITE_URL', Env::get('APP_URL', 'http://localhost:8000')) ?? 'http://localhost:8000'));
