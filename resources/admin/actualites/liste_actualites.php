        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2>Actualités</h2>
                    <a href="/admin/actualites/create" class="btn btn-primary">
                                ...
                                <tbody>
                                    <?php if (!empty($actualites)): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/admin/actualites/edit/<?php echo $actualite['id']; ?>" class="btn btn-sm btn-primary">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <a href="/admin/actualites/delete/<?php echo $actualite['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette actualité ?')">
